...
Scenario relevance (see applying.md): this is the kernel of the geospatial
variants of S07 (haul routing) and S10 (ambulance dispatch) — real maps are
loaded the same way, only the geometry source differs (OSMnx/GeoJSON instead
of hand-built points).
