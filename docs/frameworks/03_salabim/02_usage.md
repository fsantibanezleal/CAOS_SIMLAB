...
to choose it over SimPy / Ciw). Landing page: [`../03_salabim.md`](../03_salabim.md).
...
> [DES guide](../../problem-types/01_discrete-event-simulation.md) and the
...
### 4.2 Doing it headless (no popup window)
