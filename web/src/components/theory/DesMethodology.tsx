    ...
    // ───────────────────────────────────────────────────────────────────────
    {
      ...
      content: (
        <div className="prose">
          ...
          <p>
            {es
              ? "Quién corre este marco de réplicas en el laboratorio importa, y es honesto ser preciso: la corrida M/M/c en vivo de S01 (SimPy) es una sola corrida de ~300 clientes —produce un W_q puntual, sin réplicas ni IC. El estudio replicado-con-IC propiamente tal es S10 (Monte-Carlo sobre joblib + SciPy): corre n réplicas independientes por régimen y dibuja la banda del IC alrededor de la media junto a la línea Erlang-C, y el aprendiz observa cómo la banda se estrecha al crecer n (deslizador), la ley 1/√n en acción, y dónde cae el valor analítico. S01 lleva además una verificación cruzada de segundo motor con Ciw (un estudio acotado de 10 réplicas que reporta un IC al 95% y si la teoría cae dentro) —ese es el corazón visual de la historia de validación."
