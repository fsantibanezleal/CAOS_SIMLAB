      ...
      content: (
        <div className="th-block">
          <div className="prose">
            ...
            <p>
              {es
                ? "El beneficio metodológico: una descripción ODD es suficientemente completa para recodificar a partir de ella, ordenada para que nada quede oculto y separable (conceptos vs. mecánica), por lo que la biblioteca documenta cada modelo entregado con una tarjeta ODD compacta."
          ...
          <div className="assume">
            ...
            <ul>
              {[
                ...
                es
                  ? "El orden estricto puede sentirse verboso para modelos diminutos; la biblioteca usa una tarjeta ODD condensada preservando el orden de los elementos."
          ...
          <div className="assume">
            ...
            <ul>
              {[
                ...
                es
                  ? "Mesa escala a agentes heterogéneos, planificación compleja, espacios de red y grandes conjuntos de modelos; es interpretado, por lo que poblaciones enormes (≳1e5 agentes) pueden necesitar batching/vectorización o motores compilados (FLAME GPU 2, ABMax). En un proyecto propio, la misma elección que hace el laboratorio se sostiene salvo a esa escala."
