...
function S02Desc({ lang }: { lang: string }) {
  ...
  return es ? (
    <>
      ...
      <p className="hint">
        También disponible como modelo <strong>NetLogo Web</strong> interactivo que se ejecuta 100% en el navegador (motor Tortoise):{" "}
  ...
  return es ? (
    <>
      ...
      <p>
        ...
        infectado (rojo), recuperado (verde). La animación avanza paso a paso: la ola roja crece, alcanza su
        pico y deja tras de sí un campo verde (recuperados). El gráfico muestra las curvas{" "}
    ...
    <>
      ...
      <p>
        ...
        (red), recovered (green). The animation steps forward and the red wave grows, peaks, and leaves a green
...
function S05Desc({ lang }: { lang: string }) {
  ...
  return es ? (
    <>
      ...
      <h3>Formalización</h3>
      <p>Es un <strong>modelo basado en agentes (ABM)</strong> determinista y secuencial: cada eslabón ejecuta una <strong>política order-up-to (base-stock) con pronóstico de suavizado exponencial</strong>. El pronóstico de la demanda recibida es exponencial simple:</p>
  ...
  return es ? (
    <>
      ...
      <p>
        ...
        qué precisión, para que mi estimador iguale la respuesta cerrada de Erlang-C? Este caso se ejecuta{" "}
      ...
      <p>
        ...
        <strong>ejecutable en vivo</strong>: Python puro y sembrado, se ejecuta en el navegador vía Pyodide (lane &ldquo;live&rdquo;); la
        traza registrada con semilla 42 también se reproduce para la galería determinista.
      </p>
