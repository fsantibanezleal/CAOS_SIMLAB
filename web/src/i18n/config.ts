...
const en = {
  ...
  live: {
    ...
    nativeBody: "This scenario uses a native solver (OR-Tools) that cannot run in the browser, so it is precomputed offline. Use the Simulator tab to compare the pre-simulated regimes.",
...
const es: typeof en = {
  ...
  live: {
    ...
    nativeBody: "Este escenario usa un solver nativo (OR-Tools) que no puede correr en el navegador, así que se precomputa fuera de línea. Usa la pestaña Simulador para comparar los regímenes pre-simulados.",
