  ...
  },
  {
    ...
    body: {
      ...
      es: [
        ...
        "OFFLINE / COMPUTE (.venv): el pipeline de precómputo ejecuta los solvers nativos sin build de WebAssembly — OR-Tools CP-SAT (S06), OR-Tools Routing + PyVRP (S08), GLOP LP (S11) y el plan de ruta NetworkX + OR-Tools de S07 — y escribe una traza sembrada compacta + manifest. El carril GPU (CuPy / Numba / Taichi / JAX) está documentado pero intencionalmente fuera de alcance.",
        "REPLAY es el respaldo común: cada escenario embarca una traza sembrada registrada, así la página pinta al instante mientras Pyodide calienta, y los escenarios nativos reproducen esa traza exactamente. La regla de 4 compuertas (classify_lane) decide live vs precómputo a partir de una medición real y lo registra en el manifest de cada escenario.",
      ],
    },
  },
  {
